...
public class FastQueue<T> implements Serializable {
	private static final long serialVersionUID = -1170083826261926407L;
	public T []data;
	public int size;
	public Class<T> type;
	...
	/**
	 * Data structure initialization is done here so that child classes can delay initialization until they are ready
	 */
