...
// C++: class Mat
//javadoc: Mat
public class Mat implements SapphireObject {
    ...
    public Mat eye(int rows, int cols, int type)
    {
    ...
    public Mat eye(Size size, int type)
    {
    ...
    public Mat ones(int rows, int cols, int type)
    {
    ...
    public Mat ones(Size size, int type)
    {
    ...
    public Mat zeros(int rows, int cols, int type)
    {
    ...
    public Mat zeros(Size size, int type)
    {
