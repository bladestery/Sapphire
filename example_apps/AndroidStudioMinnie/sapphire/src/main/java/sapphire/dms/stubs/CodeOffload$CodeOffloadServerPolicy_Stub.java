/*
 * Stub for class sapphire.policy.offload.CodeOffload.CodeOffloadServerPolicy
...
public final class CodeOffload$CodeOffloadServerPolicy_Stub extends sapphire.policy.offload.CodeOffload.CodeOffloadServerPolicy implements sapphire.kernel.common.KernelObjectStub {
    ...
    public CodeOffload$CodeOffloadServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        CodeOffload$CodeOffloadServerPolicy_Stub other = (CodeOffload$CodeOffloadServerPolicy_Stub) obj;
    ...
    public void syncObject(java.io.Serializable $param_Serializable_1) {
        ...
        String $__method = "public void sapphire.policy.offload.CodeOffload$CodeOffloadServerPolicy.syncObject(java.io.Serializable)";
    ...
    public sapphire.policy.SapphirePolicy.SapphireServerPolicy replicate() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.policy.SapphirePolicy$SapphireServerPolicy sapphire.policy.offload.CodeOffload$CodeOffloadServerPolicy.replicate()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public void onMembershipChange() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.offload.CodeOffload$CodeOffloadServerPolicy.onMembershipChange()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireGroupPolicy $param_SapphirePolicy$SapphireGroupPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.offload.CodeOffload$CodeOffloadServerPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireGroupPolicy)";
    ...
    public sapphire.kernel.common.KernelOID getOID() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.kernel.common.KernelOID sapphire.policy.offload.CodeOffload$CodeOffloadServerPolicy.getOID()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public sapphire.policy.SapphirePolicy.SapphireGroupPolicy getGroup() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.policy.SapphirePolicy$SapphireGroupPolicy sapphire.policy.offload.CodeOffload$CodeOffloadServerPolicy.getGroup()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public sapphire.common.AppObject getAppObject() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.common.AppObject sapphire.policy.offload.CodeOffload$CodeOffloadServerPolicy.getAppObject()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    // Implementation of DummyFunc()
    public void DummyFunc() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.offload.CodeOffload$CodeOffloadServerPolicy.DummyFunc()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
