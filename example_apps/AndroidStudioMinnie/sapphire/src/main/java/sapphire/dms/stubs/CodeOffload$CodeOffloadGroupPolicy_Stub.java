/*
 * Stub for class sapphire.policy.offload.CodeOffload.CodeOffloadGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class CodeOffload$CodeOffloadGroupPolicy_Stub extends sapphire.policy.offload.CodeOffload.CodeOffloadGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public CodeOffload$CodeOffloadGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        CodeOffload$CodeOffloadGroupPolicy_Stub other = (CodeOffload$CodeOffloadGroupPolicy_Stub) obj;
    ...
    public sapphire.policy.SapphirePolicy.SapphireServerPolicy onRefRequest() {
        ...
        String $__method = "public sapphire.policy.SapphirePolicy$SapphireServerPolicy sapphire.policy.offload.CodeOffload$CodeOffloadGroupPolicy.onRefRequest()";
    ...
    public void onFailure(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.offload.CodeOffload$CodeOffloadGroupPolicy.onFailure(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.offload.CodeOffload$CodeOffloadGroupPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
        $__params.add($param_SapphirePolicy$SapphireServerPolicy_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
    ...
    public java.util.ArrayList getServers() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public java.util.ArrayList<sapphire.policy.SapphirePolicy$SapphireServerPolicy> sapphire.policy.offload.CodeOffload$CodeOffloadGroupPolicy.getServers()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public void addServer(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.offload.CodeOffload$CodeOffloadGroupPolicy.addServer(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
        $__params.add($param_SapphirePolicy$SapphireServerPolicy_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
