/*
 * Stub for class boofcv.abst.feature.detect.line.DetectLineHoughFootSubimage
 * Generated by Sapphire Compiler (sc).
 */
package boofcv.abst.feature.detect.line.stubs;


public final class DetectLineHoughFootSubimage_Stub extends boofcv.abst.feature.detect.line.DetectLineHoughFootSubimage implements sapphire.common.AppObjectStub {

    sapphire.policy.SapphirePolicy.SapphireClientPolicy $__client = null;
    boolean $__directInvocation = false;

    public DetectLineHoughFootSubimage_Stub (int $param_int_1, int $param_int_2, int $param_int_3, float $param_float_4, int $param_int_5, int $param_int_6, int $param_int_7, boofcv.abst.filter.derivative.ImageGradient $param_ImageGradient_8, boofcv.struct.image.ImageType $param_ImageType_9, boofcv.factory.feature.detect.extract.FactoryFeatureExtractor $param_FactoryFeatureExtractor_10) {
        super($param_int_1, $param_int_2, $param_int_3, $param_float_4, $param_int_5, $param_int_6, $param_int_7, $param_ImageGradient_8, $param_ImageType_9, $param_FactoryFeatureExtractor_10);
    }
    ...
    public boofcv.alg.feature.detect.line.HoughTransformLineFootOfNorm getTransform() {
        ...
        try {
            if ($__directInvocation)
                ...
                String $__method = "public boofcv.alg.feature.detect.line.HoughTransformLineFootOfNorm boofcv.abst.feature.detect.line.DetectLineHoughFootSubimage.getTransform()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        return ((boofcv.alg.feature.detect.line.HoughTransformLineFootOfNorm) $__result);
    }
    ...
    public boofcv.struct.image.GrayF32 getEdgeIntensity() {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public boofcv.struct.image.GrayF32 boofcv.abst.feature.detect.line.DetectLineHoughFootSubimage.getEdgeIntensity()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boofcv.struct.image.ImageGray getDerivY() {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public D boofcv.abst.feature.detect.line.DetectLineHoughFootSubimage.getDerivY()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boofcv.struct.image.ImageGray getDerivX() {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public D boofcv.abst.feature.detect.line.DetectLineHoughFootSubimage.getDerivX()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boofcv.struct.image.GrayU8 getBinary() {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public boofcv.struct.image.GrayU8 boofcv.abst.feature.detect.line.DetectLineHoughFootSubimage.getBinary()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
