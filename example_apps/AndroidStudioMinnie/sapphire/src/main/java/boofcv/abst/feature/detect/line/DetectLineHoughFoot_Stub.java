/*
 * Stub for class boofcv.abst.feature.detect.line.DetectLineHoughFoot
 * Generated by Sapphire Compiler (sc).
 */
package boofcv.abst.feature.detect.line.stubs;


public final class DetectLineHoughFoot_Stub extends boofcv.abst.feature.detect.line.DetectLineHoughFoot implements sapphire.common.AppObjectStub {

    sapphire.policy.SapphirePolicy.SapphireClientPolicy $__client = null;
    boolean $__directInvocation = false;

    public DetectLineHoughFoot_Stub (int $param_int_1, int $param_int_2, int $param_int_3, float $param_float_4, int $param_int_5, boofcv.abst.filter.derivative.ImageGradient $param_ImageGradient_6, boofcv.struct.image.ImageType $param_ImageType_7, boofcv.factory.feature.detect.extract.FactoryFeatureExtractor $param_FactoryFeatureExtractor_8) {
        super($param_int_1, $param_int_2, $param_int_3, $param_float_4, $param_int_5, $param_ImageGradient_6, $param_ImageType_7, $param_FactoryFeatureExtractor_8);
    }
    ...
    public boofcv.alg.feature.detect.line.HoughTransformLineFootOfNorm getTransform() {
        ...
        try {
            if ($__directInvocation)
                ...
                String $__method = "public boofcv.alg.feature.detect.line.HoughTransformLineFootOfNorm boofcv.abst.feature.detect.line.DetectLineHoughFoot.getTransform()";
    ...
    public boofcv.struct.image.GrayF32 getEdgeIntensity() {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public boofcv.struct.image.GrayF32 boofcv.abst.feature.detect.line.DetectLineHoughFoot.getEdgeIntensity()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boofcv.struct.image.ImageGray getDerivY() {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public D boofcv.abst.feature.detect.line.DetectLineHoughFoot.getDerivY()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boofcv.struct.image.ImageGray getDerivX() {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public D boofcv.abst.feature.detect.line.DetectLineHoughFoot.getDerivX()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boofcv.struct.image.GrayU8 getBinary() {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public boofcv.struct.image.GrayU8 boofcv.abst.feature.detect.line.DetectLineHoughFoot.getBinary()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
