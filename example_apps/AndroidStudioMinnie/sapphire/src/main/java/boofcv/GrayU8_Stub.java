/*
 * Stub for class boofcv.struct.image.GrayU8
 * Generated by Sapphire Compiler (sc).
 */
package boofcv.struct.image.stubs;


public final class GrayU8_Stub extends boofcv.struct.image.GrayU8 implements sapphire.common.AppObjectStub {
    ...
    public GrayU8_Stub (int $param_int_1, int $param_int_2) {
    ...
    public int unsafe_get(int $param_int_1, int $param_int_2) {
        ...
        try {
            if ($__directInvocation)
                ...
                String $__method = "public int boofcv.struct.image.GrayU8.unsafe_get(int,int)";
    ...
    public boofcv.struct.image.ImageDataType getDataType() {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public boofcv.struct.image.ImageDataType boofcv.struct.image.GrayU8.getDataType()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boofcv.struct.image.GrayU8 createNew(int $param_int_1, int $param_int_2) {
        java.lang.Object $__result = null;
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public boofcv.struct.image.GrayU8 boofcv.struct.image.GrayU8.createNew(int,int)";
                $__params.add($param_int_1);
                $__params.add($param_int_2);
                $__result = $__client.onRPC($__method, $__params);
            }
