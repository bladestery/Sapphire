...
public final class BinaryPolygonDetector_Stub extends boofcv.alg.shapes.polygon.BinaryPolygonDetector implements sapphire.common.AppObjectStub {
    ...
    // Implementation of setLensDistortion(int, int, PixelTransform2_F32, PixelTransform2_F32, FactoryImageBorder, FactoryInterpolation)
    public void setLensDistortion(int $param_int_1, int $param_int_2, boofcv.struct.distort.PixelTransform2_F32 $param_PixelTransform2_F32_3, boofcv.struct.distort.PixelTransform2_F32 $param_PixelTransform2_F32_4, boofcv.core.image.border.FactoryImageBorder $param_FactoryImageBorder_5, boofcv.factory.interpolate.FactoryInterpolation $param_FactoryInterpolation_6) {
        java.lang.Object $__result = null;
        try {
            if ($__directInvocation)
                super.setLensDistortion( $param_int_1,  $param_int_2,  $param_PixelTransform2_F32_3,  $param_PixelTransform2_F32_4,  $param_FactoryImageBorder_5,  $param_FactoryInterpolation_6);
            else {
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public void boofcv.alg.shapes.polygon.BinaryPolygonDetector.setLensDistortion(int,int,boofcv.struct.distort.PixelTransform2_F32,boofcv.struct.distort.PixelTransform2_F32,boofcv.core.image.border.FactoryImageBorder,boofcv.factory.interpolate.FactoryInterpolation)";
                $__params.add($param_int_1);
                $__params.add($param_int_2);
    ...
    // Implementation of clearLensDistortion(FactoryImageBorder, FactoryInterpolation)
    public void clearLensDistortion(boofcv.core.image.border.FactoryImageBorder $param_FactoryImageBorder_1, boofcv.factory.interpolate.FactoryInterpolation $param_FactoryInterpolation_2) {
        java.lang.Object $__result = null;
        try {
            if ($__directInvocation)
                super.clearLensDistortion( $param_FactoryImageBorder_1,  $param_FactoryInterpolation_2);
            else {
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public void boofcv.alg.shapes.polygon.BinaryPolygonDetector.clearLensDistortion(boofcv.core.image.border.FactoryImageBorder,boofcv.factory.interpolate.FactoryInterpolation)";
                $__params.add($param_FactoryImageBorder_1);
                $__params.add($param_FactoryInterpolation_2);
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
