...
public class EnhanceImageOps implements SapphireObject {
	 ...
	 */
	public void equalize( int histogram[] , int transform[] ) {
	 ...
	 */
	public void applyTransform(GrayU8 input , int transform[] , GrayU8 output , InputSanityCheck ISC) {
	 ...
	 * @param output Output image.
	 */
	public void applyTransform(GrayU16 input , int transform[] , GrayU16 output , InputSanityCheck ISC) {
		ISC.checkSameShape(input, output);
	 ...
	 * @param output Output image.
	 */
	public void applyTransform(GrayS8 input , int transform[] , int minValue, GrayS8 output , InputSanityCheck ISC) {
		ISC.checkSameShape(input, output);
	 ...
	 * @param output Output image.
	 */
	public void applyTransform(GrayS16 input , int transform[] , int minValue, GrayS16 output, InputSanityCheck ISC ) {
		ISC.checkSameShape(input, output);
	 ...
	 * @param output Output image.
	 */
	public void applyTransform(GrayS32 input , int transform[] , int minValue, GrayS32 output , InputSanityCheck ISC) {
		ISC.checkSameShape(input, output);
	 ...
	 */
	public void equalizeLocal(GrayU8 input , int radius , GrayU8 output ,
									 int histogram[] , int transform[], ImageStatistics IS, InputSanityCheck ISC) {
		...
		if( input.width >= width && input.height >= width ) {
			...
			applyTransform(input,transform,output, ISC);
		} else {
	 ...
	 * @param transform Storage for transformation table.  Must be large enough to contain all possible values.
	 */
	public void equalizeLocal(GrayU16 input , int radius , GrayU16 output ,
									 int histogram[] , int transform[], ImageStatistics IS, InputSanityCheck ISC) {
	 ...
	 * @param output Output image.
	 */
	public void sharpen4(GrayU8 input , GrayU8 output , InputSanityCheck ISC) {
		ISC.checkSameShape(input, output);
	 ...
	 * @param output Output image.
	 */
	public void sharpen4(GrayF32 input , GrayF32 output, InputSanityCheck ISC) {
		ISC.checkSameShape(input, output);
	 ...
	 * @param output Output image.
	 */
	public void sharpen8(GrayU8 input , GrayU8 output , InputSanityCheck ISC) {
		ISC.checkSameShape(input, output);
	 ...
	 * @param output Output image.
	 */
	public void sharpen8(GrayF32 input , GrayF32 output , InputSanityCheck ISC) {
		ISC.checkSameShape(input, output);
