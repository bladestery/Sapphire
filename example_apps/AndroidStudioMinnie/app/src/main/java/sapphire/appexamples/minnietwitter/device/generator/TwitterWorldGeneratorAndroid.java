...
public class TwitterWorldGeneratorAndroid {
	...
	public static void main(String[] args) {
		...
		try {
			for (;;) {
				registry = LocateRegistry.getRegistry("192.168.1.10", 22346);
				OMSServer server = (OMSServer) registry.lookup("SapphireOMS");
				//System.out.println(server);
				KernelServer nodeServer = new KernelServerImpl(new InetSocketAddress("192.168.1.16", 22346), new InetSocketAddress("192.168.1.10", 22346));
				//System.out.println(nodeServer);
				//System.out.println("Created nodeServer");
				//Thread.sleep(100);
				//if (1==1) break;
