...
public class CascadeClassifier implements SapphireObject<sapphire.policy.offload.CodeOffload> {
    ...
    public boolean convert(String oldcascade, String newcascade)
    {
